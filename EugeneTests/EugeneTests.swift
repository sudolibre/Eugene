...
class EugeneTests: XCTestCase {
    ...
    func testEndpointLogin() {
        ...
        EugeneAPI.contactAPIFor(endPoint: .loginEndpoint(email: "test@gmail.com", password: "password")) { (result) in
    ...
    func testEndpointRegister() {
        let person = Person(givenName: "TJ", familyName: "Usomething", company: "TIY", picture: nil, sharePicture: false, ID: 8675309)
